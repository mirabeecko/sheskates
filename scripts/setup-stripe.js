...
async function main() {
  ...
  const productSolo = await stripePost("products", {
    name: "1 osoba",
    description: "Víkendový longboard kemp pro ženy – 2 dny / 1 noc, kompletní vybavení. Jedna účastnice.",
  });
  ...
  const productDuo = await stripePost("products", {
    name: "Já a kámoška",
    description: "Víkendový longboard kemp pro ženy – 2 dny / 1 noc, kompletní vybavení. Akce pro dvě osoby."
  });
